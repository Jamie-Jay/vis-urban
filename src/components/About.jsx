      ...
      <div className="modal">
        ...
        <div className="content">
          <p>
            ...
            <a href='https://api.buswatcher.org/docs' target="_blank" rel="noreferrer" 
              style={{color: 'black'}}
          ...
          <p>
            ...
            <a href='https://vj9tinkr4k.execute-api.us-east-1.amazonaws.com/dev/ALL' target="_blank" rel="noreferrer" 
              style={{color: 'black'}}
            > API Hao develops </a>
          ...
          <p>This application is developed by 
            <a href='mailto:hg457@cornell.edu' target="_blank" rel="noreferrer" 
              style={{color: 'black'}}> Hao Geng </a> 
            and advised by 
            <a href='mailto:amt353@cornell.edu' target="_blank" rel="noreferrer" 
              style={{color: 'black'}}> Anthony Townsend</a>
            .
          </p>
